...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var lottieComposition: LottieResult<LottieComposition>?
        Handler(Looper.getMainLooper()).postDelayed({
            lottieComposition = LottieCompositionFactory.fromRawResSync(this, R.raw.android_wave)
        ...
        }, 0) // Make sure to call this on a background thread!
    }
